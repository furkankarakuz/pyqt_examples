...
class Main(QMainWindow):
    ...
    def action_process(self):
        self.color_action = QAction(QIcon(self.color_pix_icon),"Select Color",self,triggered=self.color_action_process)
        self.fill_action = QAction(QIcon("icon/bucket.png"),"Fill",self,triggered=self.fill_action_process)
        ...
        self.open_file_action = QAction("Open File",self,triggered=self.open_file_action_process)
        self.open_file_action.setShortcut("Ctrl+N")

        self.save_file_action = QAction("Save File",self,triggered=self.save_file_action_process)
    ...
    def open_file_action_process(self):
        ...
        self.window_label.setPixmap(QPixmap(selected_file[0]).scaled(self.window_label.size()))
